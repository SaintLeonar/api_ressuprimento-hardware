...
module.exports = (sequelize, DataTypes) => {
  class Transportadora_Internacional extends Model {
    ...
    static associate(models) {
      ...
      Transportadora_Internacional.hasMany(models.Transportadora_Alfandega_Internacional, {
        foreignKey: 'transportadora_internacional_id'
      })

      Transportadora_Internacional.hasMany(models.Transportadora_Alfandega_Nacional, {
        foreignKey: 'transportadora_internacional_id'
      })
    }
  }
  Transportadora_Internacional.init({
    ...
    tableName: 'Transportadora_Internacional'
  });
